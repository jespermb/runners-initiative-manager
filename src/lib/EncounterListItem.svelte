<script lang="ts">
    ...
    function edit() {
        ...
        alert(`Edit encounter: ${name} (ID: ${id})`);
    ...
    async function saveEdit() {
        // This would be implemented to save the edited encounter
        // await invoke("update_encounter", { id, name: editName });
        // showEditForm = false;
        // dispatch("encounterUpdated");
    }
</script>
...
{#if showEditForm}
    <div class="modal-overlay">
        <div class="modal-content">
            <h3 class="text-lg font-bold mb-4">Edit Encounter</h3>
            <input
                type="text"
                bind:value={editName}
